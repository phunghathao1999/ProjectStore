...
namespace Server.Migrations
{
    ...
    [Migration("20210402092919_MyFirstMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationCore.Entity.ProductAvatar", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ApplicationCore.Entity.ProductAvatar", b =>
                {
                    b.HasOne("ApplicationCore.Entity.Product", "product")
                        .WithOne("ProductAvatar")
                        .HasForeignKey("ApplicationCore.Entity.ProductAvatar", "productID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
